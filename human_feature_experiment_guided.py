...
def main():
    ...
    experiment_data_dir = '/Users/ullrich/ullrich_ws/Projects/Greeting_Learning/experiment_data/human_feature_exp/guided_collect/'
    ...
    with mp_pose.Pose(min_detection_confidence=0.5,
        ...
        agent.stop()
        cam.release()
        print("Guided human-feature experiments finished")
