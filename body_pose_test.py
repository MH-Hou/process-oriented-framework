...
with mp_pose.Pose(
  ...
  while not keyboard.is_pressed("q") or not keyboard.is_pressed("Q"):
    ...
    # print("right wrist x: {}".format(results.pose_world_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_WRIST].x))
    # print("right wrist y: {}".format(results.pose_world_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_WRIST].y))
    print("left heel x: {}, y: {}, z: {}".format(results.pose_world_landmarks.landmark[mp_pose.PoseLandmark.LEFT_HEEL].x,
                                                   results.pose_world_landmarks.landmark[mp_pose.PoseLandmark.LEFT_HEEL].y,
                                                   results.pose_world_landmarks.landmark[mp_pose.PoseLandmark.LEFT_HEEL].z))
