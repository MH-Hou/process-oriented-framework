...
with mp_hands.Hands(
  ...
  while not keyboard.is_pressed("q") or not keyboard.is_pressed("Q"):
    ...
    if results.multi_hand_landmarks:
      ...
      # for hand_world_landmarks in results.multi_hand_world_landmarks:
          # print('hand_landmarks:', hand_world_landmarks)
          # print(
          #     f'wrist coordinates: (',
          #     f'{hand_world_landmarks.landmark[mp_hands.HandLandmark.WRIST].x}, '
          #     f'{hand_world_landmarks.landmark[mp_hands.HandLandmark.WRIST].y}, '
          #     f'{hand_world_landmarks.landmark[mp_hands.HandLandmark.WRIST].z})'
          # )
    # print("***********************************************")
